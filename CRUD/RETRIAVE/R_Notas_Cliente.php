...
$sql2 = "SELECT DISTINCT `NR` as `Nota` FROM `estoque` 
        WHERE ((`ProdutoID` = $TEMP_Produto ) AND (`ClienteID` = $TEMP_Cliente ) AND (`Data_Estoque` between ('$Data_Inicio') AND ('$Data_Final') ) );";
